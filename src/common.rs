...
pub const PORTABLE_APPNAME_RUNTIME_ENV_KEY: &str = "ZDESK_APPNAME";
...
#[inline]
pub fn is_zdesk() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("ZDesk")
}
...
pub type ZDeskInterval = ThrottledInterval;

#[inline]
pub fn zdesk_interval(i: Interval) -> ThrottledInterval {
