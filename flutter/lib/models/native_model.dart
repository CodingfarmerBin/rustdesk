...
class PlatformFFI {
  ...
  ZdeskImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    final dylib = isAndroid
        ? DynamicLibrary.open('libzdesk.so')
        : isLinux
        ? DynamicLibrary.open('libzdesk.so')
        : isWindows
        ? DynamicLibrary.open('zdesk.dll')
        :
          ...
          //
          // isMacOS? DynamicLibrary.open("libzdesk.dylib") :
  ...
  void _startListenEvent(ZdeskImpl rustdeskImpl) {
